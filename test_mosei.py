...
def parse_args():
    parser = ArgumentParser(description='Test MOSEI model with specified parameters')
    parser.add_argument('--model_save_path', type=str, required=True,
                      help='Path to the saved model file')
    parser.add_argument('--seed', type=int, default=1114,
                      help='Random seed for reproducibility')
    parser.add_argument('--output_file', type=str, default='./test_results/mosei_mr4_seed1114_maml.txt',
...
def initialize_args(mr_value, model_save_path):
    ...
    return {
        'model_name': 'imder',
        'dataset_name': 'mosei',
        'featurePath': 'dataset/MOSEI/aligned_50.pkl',
        ...
        # 你需要将模型的实际保存路径改成你训练 MOSEI 的 pth
...
if __name__ == "__main__":
    ...
    print(f"所有 MOSEI 测试结果已保存到 '{args.output_file}'。")
